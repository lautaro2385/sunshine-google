...
////                mContext.getString(R.string.unit_metric));
////
////        if (unitType.equals(mContext.getString(R.string.unit_imperial))) {
////            high = (high * 1.8) + 32;
////            low = (low * 1.8) + 32;
////        } else if (!unitType.equals(mContext.getString(R.string.unit_metric))) {
...
//                cVVector.toArray(cv);
////                mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cv);
////            }
////
...
//                inserted = mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cv);
//            }
//
